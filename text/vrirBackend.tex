...
\item Arglist : Contains a list of the ids of the input arguments refererring to their Symbol table entries. They are used to fetch the name of the Symbol table. 
\item Func type : The Func type is used for generating the input argument types and the return type.
\item Body : It refers to the function body and is converted to C++ sstments. 
\end{itemize}
