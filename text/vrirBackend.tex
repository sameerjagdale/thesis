...
\label{tab:breakStmt}
\end{table}
The break statement of VRIR is compiled to the break statement in C++. Table \ref{tab:breakStmt} gives an example of the break statement.
...
\hline
\end{tabular}
\caption[Continue statement example]{The table shows an example of a continue statement in VRIR and its equivalent C++ break statement}
